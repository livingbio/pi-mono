					...
					if (compressed) {
						...
						return {
							content: [
								{
									type: "text",
									text: `Image file is too large (${sizeMB}MB base64, max 5MB) and could not be compressed. No image tool (ImageMagick) available. Consider resizing the image manually.`,
								},
							],
							details: undefined,
						};
